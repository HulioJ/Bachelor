...
################ SOCIAL EXCLUSION ############
  ...
  geom_errorbar( aes(x=shortened_questions, ymin=soc_ex_resp_mean-soc_ex_resp_sd, ymax=soc_ex_resp_mean+soc_ex_resp_sd), width=0.4, colour="orange", alpha=0.9, size=1.3)
